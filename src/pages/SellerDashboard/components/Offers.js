		...
		return (
			<div className='card p-3'>
				...
				<Collapse isOpen={this.state.collapse}>
					{!this.state.offers.length && <span className='text-muted'>No offers yet</span>}
						...
						return (
							<div key={offer._id} className='row offer-info'>
								...
								<div className='col-2'>
									<div className='btn-toolbar' role='toolbar' aria-label='Toolbar with button groups'>
										<div className='btn-group mr-2' role='group' aria-label='First group'>
											<img src={ChatIcon} onClick={this.openMessage.bind(null, offer)} alt='' />
										</div>
								...
								<div className='col-2 text-right'>
									...
									{!offer.accepted && (
										<button onClick={this.acceptOffer.bind(null, offer)} className='btn btn-light'>
											Accept
										</button>
									)}
								</div>
