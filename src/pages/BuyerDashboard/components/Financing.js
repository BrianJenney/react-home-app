        ...
        return (
            <div className="card p-3">
                ...
                <Collapse isOpen={this.state.collapse}>
                    ...
                    <a target="_blank" href="https://rocketmortgage.com">
                    ...
                    <p className="paragraph d-inline">
                        Upload your preapproval letter
                    </p>
                    ...
                    {this.state.loanDocument.length > 0 && (
                        <div className="d-inline">
                            <i
                                ...
                                aria-hidden="true"
                            />
                            <a target="_blank" href={this.state.loanDocument}>
                    ...
                    />
                    <p className="paragraph d-inline">
                        Upload proof of funds for your downpayment. This can be
                        a bank statement, stocks or retirement account
                    </p>
                    <FileUpload
