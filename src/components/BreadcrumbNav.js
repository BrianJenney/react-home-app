			...
			<footer>
				<div>
					<nav className='bottom-nav'>
						<ul>
							<li>
								<img class='micasa-nav-logo' src={greenLogo} />
							</li>
							<li>
								<a className='crumb-link' onClick={this.handleClick} href='JavaScript:Void(0);'>
								...
								>
									<li className='pop-over-item' onClick={this.switchUserType.bind(null, 'buyer')}>
										Buyer
									</li>
									<li className='pop-over-item' onClick={this.switchUserType.bind(null, 'seller')}>
										Seller
									</li>
								</Popover>
							</li>
